...
# loop over Coco 3 disk images with artwork and run them for 180 seconds (-seconds_to_run option) each
...
do
	...
	mame coco3 -flop1 "$file" -seconds_to_run 180 -autoboot_delay 2 -autoboot_command "LOADM \"$1\":EXEC\n" $MAMEPARMS -nothrottle

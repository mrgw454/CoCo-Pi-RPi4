...
xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -machine-cart ide -type 'N\rDRIVE I 1,4,3\rDRIVE U 0\rDRIVE M 0,1,0,0,0\rDRIVE M 1,0,0\rDRIVE I:DRIVE M\rLOAD"WIDTH32.BAS:1"\rRUN\r' $XROARPARMS

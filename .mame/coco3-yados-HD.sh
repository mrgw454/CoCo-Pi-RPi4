...
mame coco3 -ramsize 512k -cart /media/share1/roms/yados.rom -ext fdcv11 -hard1 /media/share1/EMU/VHD/HDD.DSK -autoboot_delay 4 -autoboot_command 'DRIVE I 1,6,3\nDRIVE U 0\nDRIVE M 0,1,0,0,0\nDRIVE M 1,0,0\nDRIVE I:DRIVE M\n\nRUN"WIDTH80.BAS:1"\n' $MAMEPARMS
...
cp $HOME/.mame/cfg/coco3.cfg.cart-start-enabled $HOME/.mame/cfg/coco3.cfg

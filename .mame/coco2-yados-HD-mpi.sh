...
mame coco2 -ramsize 64k -ext multi -ext:multi:slot4 fdcv11 -cart5 /media/share1/roms/yados.rom -hard1 /media/share1/EMU/VHD/HDD.DSK -autoboot_delay 8 -autoboot_command 'N\nDRIVE I 1,6,3\nDRIVE U 0\nDRIVE M 0,1,0,0,0\nDRIVE M 1,0,0\nDRIVE I:DRIVE M\n\nRUN"WIDTH32.BAS:1"\n' $MAMEPARMSFILE

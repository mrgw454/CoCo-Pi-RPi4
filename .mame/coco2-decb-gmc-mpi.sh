...
then
	...
	mame coco2 -ramsize 64k -ext multi -ext:multi:slot1 games_master -flop1 "$floppy" $MAMEPARMS
...
mame coco2 -ramsize 64k -ext multi -ext:multi:slot1 games_master $MAMEPARMS
